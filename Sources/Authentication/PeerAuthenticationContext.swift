...
/// call.
///
/// The counterpart of ``AuthenticationContext``. A person proves who they are with a bearer
...
///
/// Like `AuthenticationContext`, it declares no task-local of its own, because a generic type
